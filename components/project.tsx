...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    <motion.div
      ...
      className="group even:pl-8 mb-3 sm:mb-8 last:m-0"
    >
      <section className=" bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8  relative sm:h-[28rem] mb-3 sm:mb-8 last:mb-0 hover:bg-gray-200 transition rounded-lg">
